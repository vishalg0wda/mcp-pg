...
export const EventLinkDeleted$zodSchema = z.enum([
  "link.deleted",
]);

export type EventLinkDeleted = z.infer<typeof EventLinkDeleted$zodSchema>;

export const EventLinkUpdated$zodSchema = z.enum([
  "link.updated",
]);

export type EventLinkUpdated = z.infer<typeof EventLinkUpdated$zodSchema>;

export const EventLinkCreated$zodSchema = z.enum([
  "link.created",
]);

export type EventLinkCreated = z.infer<typeof EventLinkCreated$zodSchema>;

export type Event = EventLinkCreated | EventLinkUpdated | EventLinkDeleted;

export const Event$zodSchema: z.ZodType<Event, z.ZodTypeDef, unknown> = z.union(
  [
    EventLinkCreated$zodSchema,
    EventLinkUpdated$zodSchema,
    EventLinkDeleted$zodSchema,
  ],
);
...
export const LinkWebhookEventGeo$zodSchema: z.ZodType<
  LinkWebhookEventGeo,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export type LinkWebhookEventTestVariant = { url: string; percentage: number };

export const LinkWebhookEventTestVariant$zodSchema: z.ZodType<
  LinkWebhookEventTestVariant,
  z.ZodTypeDef,
  unknown
> = z.object({
  percentage: z.number(),
...
export type LinkWebhookEventLink = {
  ...
  testVariants?: Array<LinkWebhookEventTestVariant> | null | undefined;
...
export const LinkWebhookEventLink$zodSchema: z.ZodType<
...
> = z.object({
  ...
  geo: z.lazy(() => LinkWebhookEventGeo$zodSchema).nullable(),
  id: z.string(),
  ...
  testVariants: z.array(z.lazy(() => LinkWebhookEventTestVariant$zodSchema))
    .nullable().optional(),
...
export type LinkWebhookEvent = {
  id: string;
  event: EventLinkCreated | EventLinkUpdated | EventLinkDeleted;
  createdAt: string;
  data: LinkWebhookEventLink;
};

export const LinkWebhookEvent$zodSchema: z.ZodType<
  LinkWebhookEvent,
  z.ZodTypeDef,
  unknown
> = z.object({
  createdAt: z.string(),
  data: z.lazy(() => LinkWebhookEventLink$zodSchema),
  event: z.union([
    EventLinkCreated$zodSchema,
    EventLinkUpdated$zodSchema,
    EventLinkDeleted$zodSchema,
  ...
  id: z.string(),
}).describe("Triggered when a link is created, updated, or deleted.");
