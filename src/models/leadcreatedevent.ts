...
export const LeadCreatedEventEvent$zodSchema = z.enum([
  "lead.created",
]);

export type LeadCreatedEventEvent = z.infer<
  typeof LeadCreatedEventEvent$zodSchema
>;
...
export const LeadCreatedEventCustomer$zodSchema: z.ZodType<
...
export const LeadCreatedEventClick$zodSchema: z.ZodType<
...
export const LeadCreatedEventGeo$zodSchema: z.ZodType<
  LeadCreatedEventGeo,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export type LeadCreatedEventTestVariant = { url: string; percentage: number };

export const LeadCreatedEventTestVariant$zodSchema: z.ZodType<
  LeadCreatedEventTestVariant,
  z.ZodTypeDef,
  unknown
> = z.object({
  percentage: z.number(),
...
export type LeadCreatedEventLink = {
  ...
  testVariants?: Array<LeadCreatedEventTestVariant> | null | undefined;
...
export const LeadCreatedEventLink$zodSchema: z.ZodType<
...
> = z.object({
  ...
  geo: z.lazy(() => LeadCreatedEventGeo$zodSchema).nullable(),
  id: z.string(),
  ...
  testVariants: z.array(z.lazy(() => LeadCreatedEventTestVariant$zodSchema))
    .nullable().optional(),
...
export const LeadCreatedEventData$zodSchema: z.ZodType<
  LeadCreatedEventData,
  z.ZodTypeDef,
  unknown
> = z.object({
  click: z.lazy(() => LeadCreatedEventClick$zodSchema),
  customer: z.lazy(() => LeadCreatedEventCustomer$zodSchema),
  eventName: z.string(),
  link: z.lazy(() => LeadCreatedEventLink$zodSchema),
});
...
export const LeadCreatedEvent$zodSchema: z.ZodType<
  LeadCreatedEvent,
  z.ZodTypeDef,
  unknown
> = z.object({
  createdAt: z.string(),
  data: z.lazy(() => LeadCreatedEventData$zodSchema),
  event: LeadCreatedEventEvent$zodSchema,
  id: z.string(),
}).describe("Triggered when a lead is created.");
