...
export const SaleCreatedEventEvent$zodSchema = z.enum([
  "sale.created",
]);

export type SaleCreatedEventEvent = z.infer<
  typeof SaleCreatedEventEvent$zodSchema
>;
...
export const SaleCreatedEventCustomer$zodSchema: z.ZodType<
...
export const SaleCreatedEventClick$zodSchema: z.ZodType<
...
export const SaleCreatedEventGeo$zodSchema: z.ZodType<
  SaleCreatedEventGeo,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export type SaleCreatedEventTestVariant = { url: string; percentage: number };

export const SaleCreatedEventTestVariant$zodSchema: z.ZodType<
  SaleCreatedEventTestVariant,
  z.ZodTypeDef,
  unknown
> = z.object({
  percentage: z.number(),
...
export type SaleCreatedEventLink = {
  ...
  testVariants?: Array<SaleCreatedEventTestVariant> | null | undefined;
...
export const SaleCreatedEventLink$zodSchema: z.ZodType<
...
> = z.object({
  ...
  geo: z.lazy(() => SaleCreatedEventGeo$zodSchema).nullable(),
  id: z.string(),
  ...
  testVariants: z.array(z.lazy(() => SaleCreatedEventTestVariant$zodSchema))
    .nullable().optional(),
...
export const SaleCreatedEventSale$zodSchema: z.ZodType<
...
export const SaleCreatedEventData$zodSchema: z.ZodType<
  SaleCreatedEventData,
  z.ZodTypeDef,
  unknown
> = z.object({
  click: z.lazy(() => SaleCreatedEventClick$zodSchema),
  customer: z.lazy(() => SaleCreatedEventCustomer$zodSchema),
  eventName: z.string(),
  link: z.lazy(() => SaleCreatedEventLink$zodSchema),
  sale: z.lazy(() => SaleCreatedEventSale$zodSchema),
});
...
export const SaleCreatedEvent$zodSchema: z.ZodType<
  SaleCreatedEvent,
  z.ZodTypeDef,
  unknown
> = z.object({
  createdAt: z.string(),
  data: z.lazy(() => SaleCreatedEventData$zodSchema),
  event: SaleCreatedEventEvent$zodSchema,
  id: z.string(),
}).describe("Triggered when a sale is created.");
